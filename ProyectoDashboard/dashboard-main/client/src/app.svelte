...
<header class="w-full bg-[#5FAFAF] dark:bg-[#590811] px-[30px] py-[20px] border border-black dark:border-[#8a9095]">
...
<main class="p-6 bg-gray-100 dark:bg-[#2a2e31] min-h-screen text-gray-900 dark:text-white">
  ...
  <div class="bg-white dark:bg-[#1d2022] rounded-xl p-6 shadow-md border border-gray-300 dark:border-[#8a9095]">
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
      ...
      <div class="mt-6">
        <h2 class="text-xl font-semibold mb-5 text-gray-900 dark:text-white ml-[200px]">Distribución Quintiles Nacional</h2>
      ...
      <div class="mt-16">
        <h2 class="text-xl font-semibold mb-5 text-gray-900 dark:text-white ml-[200px]">Centil medio de los hijos por CCAA</h2>
        <MapaEspaña />
      </div>
